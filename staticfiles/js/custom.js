...
function changeOrderDetailCount(detailId, state) {
    ...
    document.getElementById("checkout_popup").onclick = function() {
  ...
  document.getElementById("confirmButton").onclick = function() {
    document.getElementById("popup").style.display = "none";
    document.getElementById("shopDoneMessage").style.display = "block";
    
    $('#order-detail-content').html('<div style="margin: 40px; padding: 100px; border: 1px solid #043637; border-radius: 10px; "><h1> سبد کالا خالی است <i class=" fa-solid fa-cart-shopping"></i> </h1></div>');

    $('#total_price').text('0');

    setTimeout(function() {
        document.getElementById("shopDoneMessage").style.display = "none";
    }, 4000);
};
